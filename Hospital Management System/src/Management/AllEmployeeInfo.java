...
public class AllEmployeeInfo extends JFrame implements ActionListener {
    ...
    public AllEmployeeInfo() {
        setTitle("👨‍⚕️ All Employee Information");
        setSize(1000, 700);
        ...
        JLabel title = new JLabel("All Employee Information");
    ...
    private void loadEmployeeData() {
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "Database Error: Could not load employee data.\n" + e.getMessage(),
                    "Database Error",
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new AllEmployeeInfo());
    }
}